...
<html lang="en">
    ...
    <body>
        <?php
            ...
            echo "  <input type='text'     name='username' required='true' placeholder='".$lang[10]."'>";
            echo "  <input type='password' name='password' required='true' placeholder='".$lang[11]."'>";
            echo "  <input type='checkbox' name='rememberMe'>".$lang[12];
            echo "  <input type='submit' value='".$lang[13]."'>";
            echo "</form>";
        ?>
    </body>
</html>